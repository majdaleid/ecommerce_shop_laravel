			...
			<div class="container">
    			...
    			<div class="col-md-12 ftco-animate">
                  ...
                  <tr class="text-center">
                    ...
                    <td class="image-prod"><div class="img" style="background-image:url(http://localhost/mecommerce/ecommerce/public/storage/product_images/{{$product['product_image']}});"></div></td>
                  ...
                  <form    method="POST" action="{{route('updateqty')}}">
                   {{csrf_field()}}
                  <td class="quantity">
