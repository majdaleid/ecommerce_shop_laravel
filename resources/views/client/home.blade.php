...
@section('content')
    <section id="home-section" class="hero">
      ...
      @foreach($sliders as $slider)
 	      <div class="slider-item" style="background-image: url(http://localhost/mecommerce/ecommerce/public/storage/slider_images/{{$slider->slider_image}});">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">{{$slider->discription1}}</h1>
	              <h2 class="subheading mb-4">{{$slider->discription2}}</h2>
    	...
    	<div class="container">
           ...
           @foreach($products as  $product)
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="http://localhost/mecommerce/ecommerce/public/storage/product_images/{{$product->product_image}}" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
